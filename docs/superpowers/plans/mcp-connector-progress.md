...
| 3   | `recipe-import` skill (skills-over-MCP delivery)             | **in-progress** — code complete (tasks 1–5); awaiting npm run check + manual verify | [`plan`](2026-05-31-mcp-phase-3-recipe-import-plan.md)                                                                   | —                                                                              | —          |
