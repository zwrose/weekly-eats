...
- [x] Task: Write tests for clickable recipe items in MealPlanViewDialog view mode
...
- [x] Task: Make recipe-type meal items clickable in MealPlanViewDialog view mode
...
- [x] Task: Write tests for RecipeViewDialog integration in MealPlanViewDialog
...
- [x] Task: Add RecipeViewDialog as a second dialog in MealPlanViewDialog
...
- [x] Task: Write tests for "Edit in Recipes" navigation from recipe dialog
...
- [x] Task: Add "Edit in Recipes" button to RecipeViewDialog when opened in read-only context
