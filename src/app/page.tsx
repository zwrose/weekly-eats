          ...
          <Container maxWidth="lg">
            ...
            >
              ...
              >
                ...
                <Button href="#for-who" color="inherit" size="small" sx={{ textTransform: 'none' }}>
                  Who it’s for
                </Button>
          ...
          >
            ...
            >
              <Box sx={{ maxWidth: 520 }}>
                ...
                >
                  Weekly Eats turns your weekly meal plan into a live, shared shopping list,
                  streamling meal prep logistics.
                </Typography>
                ...
                <Typography variant="caption" sx={{ color: 'text.secondary' }}>
                  Currently in limited beta - your account will require approval.
                </Typography>
              </Box>
            </Box>
          </Paper>
            ...
            >
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 2, bgcolor: 'background.paper' }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Build flexible plans that match your real life—recipes, staples, and ingredient
                  groups all in one view.
                </Typography>
              </Paper>
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 2, bgcolor: 'background.paper' }}>
                <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 1 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Everyone sees the same list. Check items off and watch them disappear in real time
                  across devices.
                </Typography>
              </Paper>
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 2, bgcolor: 'background.paper' }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Keep units and quantities consistent, resolve conflicts, and quickly adjust based
                  on what&apos;s already in your pantry.
                </Typography>
              </Paper>
            </Box>
          </Box>
          ...
          <Box id="for-who" sx={{ mb: { xs: 8, md: 10 } }}>
            ...
            >
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 2, bgcolor: 'background.paper' }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Share the plan, share the list, and let anyone jump in to help with the shopping
              ...
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 2, bgcolor: 'background.paper' }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Coordinate meals and staples so you stop buying duplicate milk and forgetting the
                  basics.
                </Typography>
              </Paper>
            </Box>
