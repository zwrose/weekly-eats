...
describe('api/meal-plans/[id] route', () => {
  ...
  it('PUT updates meal plan when valid', async () => {
    ...
    const res = await routes.PUT(
      makeReq('http://localhost/api/meal-plans/p1', { name: 'Updated' }),
      { params: Promise.resolve({ id: '64b7f8c2a2b7c2f1a2b7c2f1' }) } as any
    );
      ...
      items: [
        {
          ...
          dayOfWeek: 'saturday',
          mealType: 'breakfast',
          items: [{ type: 'foodItem', id: '507f1f77bcf86cd799439011', quantity: 3, unit: 'piece' }],
        },
      ],
      createdAt: new Date(),
    });
      ...
      items: [
        {
          ...
          dayOfWeek: 'saturday',
          mealType: 'staples',
          items: [{ type: 'foodItem', id: '507f1f77bcf86cd799439011', quantity: 1, unit: 'piece' }],
        },
      ],
      createdAt: new Date(),
    });
