...
export const FOOD_UNITS: FoodUnit[] = [
  ...
  // Container types
  {
    ...
    abbreviationPlural: 'containers',
  },
  { singular: 'pouch', plural: 'pouches', abbreviation: 'pouch', abbreviationPlural: 'pouches' },

  // Special combinations
  {
    singular: 'fluid ounce can',
    plural: 'fluid ounce cans',
    abbreviation: 'fl oz can',
    abbreviationPlural: 'fl oz cans',
  },
  {
    singular: 'fluid ounce container',
    plural: 'fluid ounce containers',
    abbreviation: 'fl oz container',
    abbreviationPlural: 'fl oz containers',
  },
  {
    singular: 'fluid ounce jar',
    plural: 'fluid ounce jars',
    abbreviation: 'fl oz jar',
    abbreviationPlural: 'fl oz jars',
  },
  {
    singular: 'fluid ounce pouch',
    plural: 'fluid ounce pouches',
    abbreviation: 'fl oz pouch',
    abbreviationPlural: 'fl oz pouches',
  },
  {
    singular: 'fluid ounce bottle',
    plural: 'fluid ounce bottles',
    abbreviation: 'fl oz bottle',
    abbreviationPlural: 'fl oz bottles',
  },
  {
    singular: 'pint container',
    plural: 'pint containers',
    abbreviation: 'pt container',
    abbreviationPlural: 'pt containers',
  },
  {
    singular: 'pound bag',
    plural: 'pound bags',
    abbreviation: 'lb bag',
    abbreviationPlural: 'lb bags',
  },
  {
    singular: 'pound can',
    plural: 'pound cans',
    abbreviation: 'lb can',
    abbreviationPlural: 'lb cans',
  },
  {
    singular: 'pound container',
    plural: 'pound containers',
    abbreviation: 'lb container',
    abbreviationPlural: 'lb containers',
  },
  {
    singular: 'ounce bag',
    plural: 'ounce bags',
    abbreviation: 'oz bag',
    abbreviationPlural: 'oz bags',
  },
  {
    singular: 'ounce can',
    plural: 'ounce cans',
    abbreviation: 'oz can',
    abbreviationPlural: 'oz cans',
  },
  {
    singular: 'ounce container',
    plural: 'ounce containers',
    abbreviation: 'oz container',
    abbreviationPlural: 'oz containers',
  },
  {
    singular: 'small ear',
    plural: 'small ears',
    abbreviation: 'sm ear',
    abbreviationPlural: 'sm ears',
  },
  {
    singular: 'small head',
    plural: 'small heads',
    abbreviation: 'sm head',
    abbreviationPlural: 'sm heads',
  },
  {
    singular: 'medium ear',
    plural: 'medium ears',
    abbreviation: 'med ear',
    abbreviationPlural: 'med ears',
  },
  {
    singular: 'medium head',
    plural: 'medium heads',
    abbreviation: 'med head',
    abbreviationPlural: 'med heads',
  },
  {
    singular: 'large ear',
    plural: 'large ears',
    abbreviation: 'lg ear',
    abbreviationPlural: 'lg ears',
  },
  {
    singular: 'large head',
    plural: 'large heads',
    abbreviation: 'lg head',
    abbreviationPlural: 'lg heads',
  },
];
...
export const normalizeUnit = (unit: string): ValidUnit | null => {
  const foodUnit = FOOD_UNITS.find(
    (u) =>
      u.singular === unit ||
      u.plural === unit ||
      u.abbreviation === unit ||
...
export const getUnitOptions = (): { value: ValidUnit; label: string }[] => {
  return FOOD_UNITS.map((unit) => ({
    value: unit.singular,
    label:
      unit.abbreviation && unit.abbreviation !== unit.singular
...
export const fetchFoodItems = async (
  ...
  Array<{ _id: string; name: string; singularName: string; pluralName: string; unit: string }>
> => {
