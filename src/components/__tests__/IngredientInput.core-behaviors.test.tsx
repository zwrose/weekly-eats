  ...
  describe('Food item creation dialog prefill', () => {
    it('should prefill dialog with typed text when Enter is pressed', async () => {
      ...
      await waitFor(
        () => {
          expect(
            screen.getByRole('button', { name: /add "new food item" as a food item/i })
          ).toBeInTheDocument();
        },
        { timeout: 3000 }
      );
    ...
    it('should prefill dialog with typed text when button is clicked', async () => {
      ...
      await waitFor(
        () => {
          expect(
            screen.getByRole('button', { name: /add "another item" as a food item/i })
          ).toBeInTheDocument();
        },
        { timeout: 3000 }
      );
      ...
      const createButton = screen.getByRole('button', {
        name: /add "another item" as a food item/i,
      });
